...
\mzGraphic{
  \begin{tblr}{
    ...
    \textbf{Algorithmus} & \textbf{Stabil} & \textbf{Speicher} & \textbf{Schlüsselvergleiche} &  &  & \textbf{Satzbewegungen} &  &  & \textbf{Komplexität} \\
    ...
    Distribution & \ding{51} & $n$ & $n$ &  & $n$ &  & $n \log n$, $n^2$ &  & Speziell $O(n)$
  \end{tblr}
}