...
\begin{itemize}
  ...
  \item $\underline{U}_1 + \underline{U}_2 = \Re(\underline{U}_1) + \Re(\underline{U}_2) + j(\Im(\underline{U}_1) + \Im(\underline{U}_2))$
  \item $\underline{U}_1 * \underline{U}_2 = U_1 U_2 e^{j(\varphi_1 + \varphi_2)}$
  \item $\frac{\underline{U}_1}{\underline{U}_2} = \frac{U_1}{U_2} e^{j(\varphi_1 - \varphi_2)}$
\end{itemize}
