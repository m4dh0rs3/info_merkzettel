...
\mzGraphic{
  \begin{tblr}{
    ...
    \textbf{Äquivalente Formeln $\mzSymbolEmph{\Leftrightarrow}$}               &                                                 & Bezeichnung \\
    ...
    $\neg (A \land B)$                         & $\neg A \mzSymbolEmph{\lor} \neg B$  & \index{\textsc{De-Morgan}}\textsc{De-Morgan}   \\
    $\neg (A \lor B)$                          & $\neg A \mzSymbolEmph{\land} \neg B$ &             \\
    $A \land (\mzMathEmph{A} \lor B)$ & $A$                                             & \index{Absoption}Absorption  \\
    $A \lor (\mzMathEmph{A} \land B)$ & $A$                                             &             \\
    $A \Rightarrow B$                          & $\mzMathEmph{\neg A} \lor B$           & \index{Elimination}Elimination \\
...
\begin{align*}
  \neg \exists x F(x) \Leftrightarrow \mzSymbolEmph{\forall} x \mzSymbolEmph{\neg} F(x) \\
  \neg \forall x F(x) \Leftrightarrow \mzSymbolEmph{\exists} x \mzSymbolEmph{\neg} F(x)
\end{align*}
...
\section[Beweistechniken]{Beweistechniken\hfill\mzEmph{\qedsymbol}}

\paragraph{Achtung:} Aus falschen Aussagen können wahre \mzEmph{und} falsche Aussagen folgen.

\begin{description}
  \item[Direkt $A \Rightarrow B$]
    \index{Direkter Beweis}
    Angenommen $A$, zeige $B$.
    Oder: Angenommen $\neg B$, zeige $\neg A$ \linebreak (\mzEmph{Kontraposition}\index{Kontraposition}).
