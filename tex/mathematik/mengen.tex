...
\paragraph{Abzählbar} \index{Abzählbarkeit} $|M| \leq |\mathbb{N}|$
...
\index{Distributivität des Verbands}
...
$\varphi$ ist ÄR. auf algebraischen Strukturen gleichen Typs
